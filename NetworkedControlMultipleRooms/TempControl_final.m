...
Tass_centr=5/abs(rho_CT_centralized);
...
Tass_decentr=5/abs(rhoCT_decentralized);
...
Tass_distr_cycle=5/abs(rhoCT_distributed_Cycle);
...
%% Star with bidirectional communication - Centre in 1
...
Tass_distr_star=5/abs(rhoCT_distributed_sbi);
